...
const addDepartment = async (req, res) => {
    try {
        ...
        const department = await depModel.create({ name, year, description, image });
...
module.exports = { upload, addDepartment, getAllDepartments, getDepartment, updateDepartment, deleteDepartment, findDepartmentsByName };
